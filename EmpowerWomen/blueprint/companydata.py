...
def define_top_15_companies():
    ...
    # First, get the distinct ABNs for companies within the specified sector
    ...
    # Then modify the top_companies_query to filter based on ABNs in companies_with_sector
    top_companies_query = db.session.query(
        ...
        .filter(Company.ABN.in_(companies_with_sector)) \
        .group_by(CompanyCategoryFinalScores.COMPANY_NAME, Company.ABN, Company.GROUP_SIZE) \
