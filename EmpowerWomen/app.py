...
from EmpowerWomen.blueprint import (home, skills, trends, privacy,terms,elevator,skillass,skillmatching,quiz,
...
app.register_blueprint(skillgap)
app.register_blueprint(careerpathway)
